...
if speed_setting == 0:
    ...
    smile_command = '/usr/local/bin/SMILExtract -C ./utils/opensmile-2.3.0/config/gemaps_50ms/eGeMAPSv01a.conf'
else:
    ...
    smile_command = '/usr/local/bin/SMILExtract -C ./utils/opensmile-2.3.0/config/gemaps_10ms/eGeMAPSv01a.conf'
